...
export const Professionals = () => {
  ...
  useEffect(() => {
    const all = loadCategories().filter(c => c.type === 'professional')
  ...
  const handleCategoryClick = (category) => {
    navigate(`/professionals/${category.id}`, { state: { category } })
  }
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Explora nuestro catálogo de profesionales certificados en diferentes especialidades
          </p>
        </div>
